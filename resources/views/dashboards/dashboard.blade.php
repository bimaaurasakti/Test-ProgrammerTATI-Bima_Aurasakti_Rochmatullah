...
@push('scripts')
    <script src="{{ asset('js/dashboards/dashboard-admin.js') }}"></script>
@endpush
               ...
               <div class="card" data-aos="fade-up" data-aos-delay="800">
                  <div class="card-header d-flex justify-content-between flex-wrap">
                     <div class="header-title">
                        ...
                        <p class="mb-0">Gross Sales This Month's</p>
                     </div>
                     <div class="d-flex align-items-center align-self-center">
                        <div class="d-flex align-items-center text-primary">
                           ...
                           <div class="ms-2">
                              <span class="text-gray">Total Gross</span>
                           </div>
                        </div>
                  ...
                  <div class="card-body">
                     <div id="income-monthly-chart" class="d-main"></div>
                  </div>
               </div>
            </div>
         </div>
